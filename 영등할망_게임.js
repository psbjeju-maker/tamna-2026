  ...
  function loop(now){
    ...
    if(finalBoss.state==='orbs'){
      finalBoss.orbs.forEach(function(o){
        if(o.dead) return;
        if(!drawImgFit(ASSETS.rockPool[ASSETS.rockPool.length-1],o.x,o.y,o.r*2.1,o.r*2.1,el*1.4)){
    ...
    if(finalBoss.state==='assault'){
      var coreY=150;
      if(!drawImgFit(ASSETS.rockPool[ASSETS.rockPool.length-1],W/2,coreY,150,150,el*2)){
